...
//    skView.showsFields = YES;
    ...
    NSDictionary *mode = @{@"PlayFieldScene":NormalMode,@"NightPlayScene":NightMode,@"SecretPlayScene":SecretMode,@"WormHolePlayScene":WormHoleMode,@"AgainstPlayScene":AgainstMode};
